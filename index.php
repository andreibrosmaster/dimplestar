...
<section class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="text-center card-hover bg-gradient-to-br from-transport-green/10 to-transport-green/20 p-8 rounded-xl">
                <div class="w-16 h-16 bg-transport-green text-white rounded-full flex items-center justify-center mx-auto mb-6">
                    <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
